        ...
        <div class="space-y-3 mb-6">
            ...
            <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <ion-icon name="person-outline" class="text-[#9CA3AF] text-[1.125rem] group-focus-within:text-[#083594] transition-colors duration-200"></ion-icon>
                </div>
                <input 
                  type="text" 
                  [value]="name()" 
            ...
            <div class="relative group">
             ...
             <div class="relative group">
                ...
                <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none text-[#9CA3AF]">
